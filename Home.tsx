      ...
      <section className="bg-brand-sage/30 py-20 mt-12 border-y-4 border-dashed border-brand-sage/50">
         <div className="container mx-auto px-6">
            ...
            <div className="grid md:grid-cols-3 gap-8">
               {[
                 { title: "Full Groom", img: "https://i.ytimg.com/vi/yEFbVOp-SXY/hq720.jpg?sqp=-oaymwEhCK4FEIIDSFryq4qpAxMIARUAAAAAGAElAADIQj0AgKJD&rs=AOn4CLBbAgisQ53tB4AVKH64oKBbjg5a8g", desc: "The works! Bath, dry, clip, style, nails & ears." },
                 { title: "Bath & Blow Dry", img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTFqtaET1ZEzmZfBWSsxHpka54WeOTSnR2orA&s", desc: "Perfect for in-between grooms to keep them smelling fresh." },
                 { title: "Puppy Intro", img: "https://hips.hearstapps.com/hmg-prod/images/newborn-puppies-1536829205.jpg?resize=640:*", desc: "A gentle first experience with lots of cuddles and treats." }
               ].map((s, i) => (
